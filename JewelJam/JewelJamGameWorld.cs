...
namespace JewelJam
{
    class JewelJamGameWorld : GameObjectList
    {
        ...
        public JewelJamGameWorld(JewelJam game)
        {
            ...
            RowSelector rowSelector = new RowSelector(grid);
            playingField.AddChild(rowSelector);
            ...
            // add the help button
            SpriteGameObject helpButton = new SpriteGameObject("spr_button_help");
        ...
        private SpriteGameObject AddOverlay(string spriteName)
        {
            // create the object
        ...
        public void ExtractScore(int points)
        {
            // increase the score
            Score -= points;
            if(Score < 0)
