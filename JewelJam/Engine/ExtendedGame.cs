...
{
    /// <summary>
    /// A subclass of Game with additional functionality that's useful for many games (especially 2D)
    /// </summary>
    class ExtendedGame : Game
    {
        ...
        /// </summary>
        /// <param name="gameTime">An MonoGame object containing information about the time that has passed.</param>
        ...
        {
            // default background color, clears the screen before every draw and draws again
        ...
        // functions all about screeen settings
