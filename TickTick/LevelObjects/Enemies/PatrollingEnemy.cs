...
namespace TickTick.LevelObjects.Enemies
{
    class PatrollingEnemy : AnimatedGameObject
    {
        ...
        public PatrollingEnemy (Level level, Vector2 startingPos) : base(TickTick.Depth_LevelObjects)
        {
            this.level = level;
            this.startingPos = startingPos;

            LoadAnimation("Sprites/LevelObjects/Flame/spr_flame@9","patrol",false,0.1f);
