...
namespace TickTick.LevelObjects.Enemies
{
    class Turtle : AnimatedGameObject
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (level.Player.CanCollideWithObjects && HasSpikesOut && HasPixelPreciseCollision(level.Player))
                level.Player.Die();
