...
using TickTick.LevelObjects.Enemies;
...
namespace TickTick
{
    partial class Level : GameObjectList
    {
        ...
        {
            Player = new Player(this, GetCellPosition(x, y) + new Vector2(TileWidth / 2, TileHeight));
            AddChild(Player);
        }
        ...
        void LoadWaterDrop(int x, int y)
        {
            ...
            WaterDrop w = new WaterDrop(this, GetCellPosition(x, y) + new Vector2(TileWidth / 2, TileHeight / 3));
